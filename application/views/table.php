                ...
                <div class="card-body">
                    ...
                    <table id="table" class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-outline-success" onclick="location.href='<?= site_url('welcome/index/'. $row['kode']) ?>'">Lihat</button>
                                <a href="<?= site_url('welcome/delete/'.$row['kode']); ?>" onclick="return confirm('Apakah ingin dihapus data ini?')"><button type="button" class="btn btn-outline-danger">Hapus</button></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
