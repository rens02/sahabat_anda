        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button style="float: right;" class='btn btn-outline-success ' onclick="window.location.href='form.php';"> Tambah Inventory</button>
                    ...
                    <table id="table" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $koneksi = mysqli_connect("localhost", "root", "", "sahabat_anda");
                            $hasil = mysqli_query($koneksi, "SELECT * FROM  sahabat_anda");
                            ...
                            foreach ($hasil as $row) {
                                ...
                                <td>
                                <img height=50; width=50; src='./images/" . $lupa . "' >
                                </td>
                                <td>
                                <button class='btn-success' onclick=\"location.href='edit.php?edit=$kode';\">Edit</button>                                
                                </td>
